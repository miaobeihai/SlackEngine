...
Terrain::Terrain(SlackEngine::Core::ComponentsManager* input_component_manager,
	...
	: SGameObject("Terrain game object")
{
	...
	//Collider
	SlackEngine::Core::RigidBodyComponent* box_collider = input_component_manager->create_box_rigidbody_component(
		scale * 5,
		position, 0.f);
