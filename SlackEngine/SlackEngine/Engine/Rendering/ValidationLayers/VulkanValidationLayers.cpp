...
SlackEngine::Render::VulkanValidationLayers::VulkanValidationLayers()
{
...
void SlackEngine::Render::VulkanValidationLayers::setup_debug_callback()
{
...
bool SlackEngine::Render::VulkanValidationLayers::check_validation_layer_support() const
{
...
bool SlackEngine::Render::VulkanValidationLayers::are_validation_layers_enabled()
{
	return enable_validation_layers;
}

std::vector<const char*> SlackEngine::Render::VulkanValidationLayers::get_validation_layers() const
{
	return validation_layers_;
}

std::vector<vk::ValidationFeatureEnableEXT> SlackEngine::Render::VulkanValidationLayers::get_enabled_features() const
{
	return enabled_features_;
}

vk::DispatchLoaderDynamic* SlackEngine::Render::VulkanValidationLayers::get_dynamic_dispatcher()
{
	return &dispatcher_;
}

VKAPI_ATTR VkBool32 VKAPI_CALL SlackEngine::Render::VulkanValidationLayers::debug_callback(
