...
void SlackEngine::Render::CameraFrustum::update(const glm::mat4& matrix)
{
...
bool SlackEngine::Render::CameraFrustum::check_sphere(const glm::vec3& pos, const float radius)
{
	for (auto& plane : planes_)
	{
