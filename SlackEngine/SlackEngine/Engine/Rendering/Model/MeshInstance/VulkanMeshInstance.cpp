...
#include "Buffer/FrameBuffer/ShadowmappingFrameBuffer/ShadowmappingFrameBufferAttachment.h"
#include "Buffer/UniformBuffer/ShadowmappingUniformBuffer/ShadowmappingUniformBuffer.h"
...
SlackEngine::Render::VulkanMeshInstance::VulkanMeshInstance(const std::string& vertex_shader_path,
...
SlackEngine::Render::VulkanMeshInstance::~VulkanMeshInstance()
{
	// Delete the textures
...
void SlackEngine::Render::VulkanMeshInstance::set_mesh_location(const Core::SVector3& location)
{
	object_location_.set_position(location);
}

void SlackEngine::Render::VulkanMeshInstance::set_mesh_rotation(const Core::SVector3& rotation)
{
	object_location_.set_rotation(rotation);
}

void SlackEngine::Render::VulkanMeshInstance::set_mesh_scale(const Core::SVector3& scale)
{
	object_location_.set_scale(scale);
}

SlackEngine::Core::SVector3 SlackEngine::Render::VulkanMeshInstance::get_mesh_location() const
{
	return object_location_.get_position();
}

SlackEngine::Core::SVector3 SlackEngine::Render::VulkanMeshInstance::get_mesh_rotation() const
{
	return object_location_.get_rotation();
}

SlackEngine::Core::SVector3 SlackEngine::Render::VulkanMeshInstance::get_mesh_scale() const
{
	return object_location_.get_scale();
}

bool SlackEngine::Render::VulkanMeshInstance::get_is_static() const
{
	return is_static_;
}

void SlackEngine::Render::VulkanMeshInstance::set_is_static(const bool is_static)
{
	is_static_ = is_static;
}

bool SlackEngine::Render::VulkanMeshInstance::get_is_visible() const
{
	return is_visible_;
}

void SlackEngine::Render::VulkanMeshInstance::set_is_visible(const bool visible)
{
	is_visible_ = visible;
}

bool SlackEngine::Render::VulkanMeshInstance::get_cast_shadows() const
{
	return cast_shadows_;
}

void SlackEngine::Render::VulkanMeshInstance::set_cast_shadows(const bool cast)
{
	cast_shadows_ = cast;
}

bool SlackEngine::Render::VulkanMeshInstance::get_frustum_check() const
{
	return frustum_check_;
}

void SlackEngine::Render::VulkanMeshInstance::set_frustum_check(const bool should_check)
{
	frustum_check_ = should_check;
}

float SlackEngine::Render::VulkanMeshInstance::get_frustum_check_radius() const
{
	return frustum_sphere_radius_multiplier_;
}

void SlackEngine::Render::VulkanMeshInstance::set_frustum_check_radius(const float radius)
{
	frustum_sphere_radius_multiplier_ = radius;
}

void SlackEngine::Render::VulkanMeshInstance::set_for_deletion()
{
	pending_deletion_ = true;
}

bool SlackEngine::Render::VulkanMeshInstance::get_pending_deletion() const
{
	return pending_deletion_;
}

void SlackEngine::Render::VulkanMeshInstance::increase_deletion_counter()
{
	deletion_counter_++;
}

uint16_t SlackEngine::Render::VulkanMeshInstance::get_deletion_counter() const
{
	return deletion_counter_;
}

void SlackEngine::Render::VulkanMeshInstance::view_frustum_check(Camera* render_camera)
{
...
void SlackEngine::Render::VulkanMeshInstance::directional_light_frustum_check(Camera* render_camera)
{
...
bool SlackEngine::Render::VulkanMeshInstance::get_is_in_current_frustum() const
{
	return is_in_current_frustum_;
}

bool SlackEngine::Render::VulkanMeshInstance::get_sun_shadow_is_in_current_frustum() const
{
	return sun_shadow_is_in_current_frustum_;
}

void SlackEngine::Render::VulkanMeshInstance::init_shadowmapping_resources(StandardShadowmapping* shadowmapping)
{
...
void SlackEngine::Render::VulkanMeshInstance::write_depth_descriptor(StandardShadowmapping* shadowmapping)
{
...
void SlackEngine::Render::VulkanMeshInstance::update_uniform_buffer(const uint32_t current_image,
...
void SlackEngine::Render::VulkanMeshInstance::update_shadowmap_uniform_buffer(const uint32_t current_image,
...
const std::vector<SlackEngine::Render::BasicMaterial*>* SlackEngine::Render::VulkanMeshInstance::
get_mesh_materials() const
{
	return &model_materials_;
}

SlackEngine::Render::ShadowmappingDescriptorSet* SlackEngine::Render::VulkanMeshInstance::
...
>> SlackEngine::Render::VulkanMeshInstance::get_mesh_buffers() const
{
