...
#include "VulkanSimpleMaterialPool.h"

#include <numeric>

#include "DebugLog.h"
#include "Buffer/Texture/Texture/StandardTexture/StandardTexture.h"
#include "Device/VulkanDevice.h"
#include "Pipeline/StandardPipeline/StandardVulkanGraphicsPipeline.h"


//Init static instance reference

SlackEngine::Render::VulkanSimpleMaterialPool* SlackEngine::Render::VulkanSimpleMaterialPool::instance_ = nullptr;

SlackEngine::Render::VulkanSimpleMaterialPool* SlackEngine::Render::VulkanSimpleMaterialPool::get_instance()
{
...
std::shared_ptr<SlackEngine::Render::BaseVulkanGraphicsPipeline> SlackEngine::Render::VulkanSimpleMaterialPool::
...
std::shared_ptr<SlackEngine::Render::BaseTexture> SlackEngine::Render::VulkanSimpleMaterialPool::get_standard_texture(
...
std::shared_ptr<SlackEngine::Render::TextureSampler> SlackEngine::Render::VulkanSimpleMaterialPool::get_texture_sampler(
	const std::string& texture_path)
{
...
std::shared_ptr<SlackEngine::Render::TextureImageView> SlackEngine::Render::VulkanSimpleMaterialPool::
...
SlackEngine::Render::VulkanSimpleMaterialPool::~VulkanSimpleMaterialPool()
{
	clear_memory();
}

void SlackEngine::Render::VulkanSimpleMaterialPool::clear_memory()
{
