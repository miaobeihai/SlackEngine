...
SlackEngine::Render::VulkanModel::VulkanModel(const std::string& input_model_path)
{
...
SlackEngine::Render::VulkanModel::~VulkanModel()
{
...
const std::vector<SlackEngine::Render::Mesh*>* SlackEngine::Render::VulkanModel::get_meshes() const
{
