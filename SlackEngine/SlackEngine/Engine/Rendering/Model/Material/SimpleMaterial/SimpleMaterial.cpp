...
#include "Descriptor/DescriptorSet/StandardDescriptorSet/StandardDescriptorSet.h"
#include "Engine/Rendering/Model/ObjectPool/VulkanSimpleMaterialPool/VulkanSimpleMaterialPool.h"

SlackEngine::Render::SimpleMaterial::SimpleMaterial()
{
...
void SlackEngine::Render::SimpleMaterial::create_pipeline(const std::string& vertex_shader_path,
...
void SlackEngine::Render::SimpleMaterial::create_texture(const std::string& texture_path)
{
...
void SlackEngine::Render::SimpleMaterial::create_descriptor_sets(VulkanSwapChain* swap_chain,
