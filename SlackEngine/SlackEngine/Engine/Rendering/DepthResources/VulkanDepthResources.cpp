...
SlackEngine::Render::VulkanDepthResources::VulkanDepthResources(const vk::Extent2D* swap_chain_extent,
...
SlackEngine::Render::VulkanDepthResources::~VulkanDepthResources()
{
...
vk::Format SlackEngine::Render::VulkanDepthResources::find_supported_format(
...
vk::Format SlackEngine::Render::VulkanDepthResources::find_depth_format()
{
...
bool SlackEngine::Render::VulkanDepthResources::has_stencil_component(const vk::Format& format)
{
	return format == vk::Format::eD32SfloatS8Uint || format == vk::Format::eD24UnormS8Uint;
}

vk::Image* SlackEngine::Render::VulkanDepthResources::get_depth_image()
{
	return &depth_image_;
}

vk::ImageView* SlackEngine::Render::VulkanDepthResources::get_depth_image_view()
{
