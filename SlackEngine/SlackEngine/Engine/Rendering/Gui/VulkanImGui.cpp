...
#include "Descriptor/DescriptorPool/GuiDescriptorPool/GuiDescriptorPool.h"
...
#include "RenderPass/GuiRenderPass/GuiRenderPass.h"


SlackEngine::Render::VulkanImGui::VulkanImGui()
{
	ImGui::CreateContext();
...
void SlackEngine::Render::VulkanImGui::init(const float width, const float height)
{
	// Dimensions
...
void SlackEngine::Render::VulkanImGui::init_resources(VulkanSwapChain* swap_chain)
{
	ImGuiIO& io = ImGui::GetIO();
...
void SlackEngine::Render::VulkanImGui::update_buffers()
{
...
void SlackEngine::Render::VulkanImGui::generate_empty_gui_frame() const
{
	pre_gui_frame();
	post_gui_frame();
}

void SlackEngine::Render::VulkanImGui::generate_loading_gui_frame() const
{
...
void SlackEngine::Render::VulkanImGui::pre_gui_frame() const
{
	//prepare the ongui() event generating a new gui event
	ImGui::NewFrame();
}

void SlackEngine::Render::VulkanImGui::post_gui_frame() const
{
	//Render to generate draw buffers
	ImGui::Render();
}

void SlackEngine::Render::VulkanImGui::loading_ui() const
{
	...
	{
		ImGui::Text("SlackEngine - Loading...");

		ImGui::End();
	}
}

SlackEngine::Render::GuiDescriptorSet* SlackEngine::Render::VulkanImGui::get_descriptor_set() const
{
	return descriptor_set_;
}

SlackEngine::Render::GuiVulkanGraphicsPipeline* SlackEngine::Render::VulkanImGui::get_pipeline() const
{
	return pipeline_;
}

SlackEngine::Render::GenericBuffer* SlackEngine::Render::VulkanImGui::get_vertex_buffer() const
{
	return vertex_buffer_;
}

SlackEngine::Render::GenericBuffer* SlackEngine::Render::VulkanImGui::get_index_buffer() const
{
	return index_buffer_;
}

SlackEngine::Render::VulkanImGui::PushConstBlock* SlackEngine::Render::VulkanImGui::get_push_const_block()
{
	return &push_const_block_;
}

SlackEngine::Render::BaseRenderPass* SlackEngine::Render::VulkanImGui::get_render_pass() const
{
