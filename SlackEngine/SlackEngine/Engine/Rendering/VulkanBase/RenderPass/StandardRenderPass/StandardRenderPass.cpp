...
SlackEngine::Render::StandardRenderPass* SlackEngine::Render::StandardRenderPass::instance_ = nullptr;

//Class

void SlackEngine::Render::StandardRenderPass::init(const vk::Format& swap_chain_image_format,
...
SlackEngine::Render::StandardRenderPass* SlackEngine::Render::StandardRenderPass::get_instance()
{
...
vk::SampleCountFlagBits SlackEngine::Render::StandardRenderPass::get_msaa_samples() const
{
