...
vk::VertexInputBindingDescription SlackEngine::Render::Vertex::get_binding_description()
{
	return vk::VertexInputBindingDescription(0, sizeof(Vertex), vk::VertexInputRate::eVertex);
}

std::array<vk::VertexInputAttributeDescription, 4> SlackEngine::Render::Vertex::get_attribute_descriptions()
{
...
vk::VertexInputBindingDescription SlackEngine::Render::SkyboxVertex::get_binding_description()
{
	return vk::VertexInputBindingDescription(0, sizeof(SkyboxVertex), vk::VertexInputRate::eVertex);
}

std::array<vk::VertexInputAttributeDescription, 3> SlackEngine::Render::SkyboxVertex::get_attribute_descriptions()
{
...
vk::VertexInputBindingDescription SlackEngine::Render::OffscreenVertex::get_binding_description()
{
	return vk::VertexInputBindingDescription(0, sizeof(OffscreenVertex), vk::VertexInputRate::eVertex);
}

std::array<vk::VertexInputAttributeDescription, 1> SlackEngine::Render::OffscreenVertex::get_attribute_descriptions()
{
