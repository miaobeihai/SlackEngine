...
void SlackEngine::Render::BaseBuffer::copy_buffer(vk::Buffer* src_buffer, vk::Buffer& dst_buffer,
...
void SlackEngine::Render::BaseBuffer::copy_buffer_to_image(vk::Buffer* buffer, vk::Image* image,
...
std::unique_ptr<vk::CommandBuffer> SlackEngine::Render::BaseBuffer::begin_single_time_command()
{
...
void SlackEngine::Render::BaseBuffer::end_and_submit_single_time_command(
