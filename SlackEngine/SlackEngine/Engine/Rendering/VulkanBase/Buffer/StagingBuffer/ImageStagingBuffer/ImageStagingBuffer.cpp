...
#include "ImageStagingBuffer.h"

#include "Buffer/BaseBuffer.h"
#include "Memory/VulkanMemoryAllocator.h"

SlackEngine::Render::ImageStagingBuffer::ImageStagingBuffer(const vk::DeviceSize& image_size, stbi_uc* pixels)
{
...
void SlackEngine::Render::ImageStagingBuffer::copy_buffer_to_image(vk::Buffer* buffer, vk::Image* image,
