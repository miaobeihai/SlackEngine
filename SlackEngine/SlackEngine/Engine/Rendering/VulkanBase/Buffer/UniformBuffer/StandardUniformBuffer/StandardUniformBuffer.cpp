#include "StandardUniformBuffer.h"
...
SlackEngine::Render::StandardUniformBuffer::StandardUniformBuffer(const size_t swap_chain_images_size)
{
...
void SlackEngine::Render::StandardUniformBuffer::update_uniform_buffer_transform(
...
void SlackEngine::Render::StandardUniformBuffer::update_uniform_buffer_camera_data(Camera* render_camera)
{
...
void SlackEngine::Render::StandardUniformBuffer::update_uniform_buffer_light_data(const glm::vec3& light_pos,
...
void SlackEngine::Render::StandardUniformBuffer::finish_update_uniform_buffer(const uint32_t current_image)
{
