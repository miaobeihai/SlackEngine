...
SlackEngine::Render::SkyboxUniformBuffer::SkyboxUniformBuffer(const size_t swap_chain_images_size)
{
...
void SlackEngine::Render::SkyboxUniformBuffer::update_uniform_buffer_transform(const Core::STransform& object_transform)
{
	//Traslate
...
void SlackEngine::Render::SkyboxUniformBuffer::update_uniform_buffer_camera_data(Camera* render_camera)
{
...
void SlackEngine::Render::SkyboxUniformBuffer::finish_update_uniform_buffer(const uint32_t current_image)
{
