...
#include "ShadowmappingFrameBufferAttachment.h"

#include "Device/VulkanDevice.h"
#include "Memory/VulkanMemoryAllocator.h"

SlackEngine::Render::ShadowmappingFrameBufferAttachment::ShadowmappingFrameBufferAttachment(const int32_t width,
...
SlackEngine::Render::ShadowmappingFrameBufferAttachment::~ShadowmappingFrameBufferAttachment()
{
...
vk::Image* SlackEngine::Render::ShadowmappingFrameBufferAttachment::get_image()
{
	return &image_;
}

vk::ImageView* SlackEngine::Render::ShadowmappingFrameBufferAttachment::get_image_view()
{
	return &image_view_;
}
