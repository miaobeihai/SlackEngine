...
SlackEngine::Render::ShadowmappingFrameBuffer::ShadowmappingFrameBuffer(const int32_t width,
...
SlackEngine::Render::ShadowmappingFrameBuffer::~ShadowmappingFrameBuffer()
{
	VulkanDevice::get_instance()->get_logical_device()->destroySampler(depth_sampler_);
	delete depth_attachment_;
}

vk::Sampler* SlackEngine::Render::ShadowmappingFrameBuffer::get_depth_sampler()
{
	return &depth_sampler_;
}

SlackEngine::Render::ShadowmappingFrameBufferAttachment* SlackEngine::Render::ShadowmappingFrameBuffer::
