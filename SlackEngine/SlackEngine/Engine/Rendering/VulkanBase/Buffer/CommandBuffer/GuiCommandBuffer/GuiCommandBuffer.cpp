...
SlackEngine::Render::GuiCommandBuffer::GuiCommandBuffer(BaseRenderPass* render_pass, VulkanCommandPool* command_pool)
...
void SlackEngine::Render::GuiCommandBuffer::init_command_buffer(
...
void SlackEngine::Render::GuiCommandBuffer::load_ui(VulkanImGui* gui)
{
	//Update buffers
	gui->update_buffers();
