...
#include "StandardCommandBuffer.h"
...
void SlackEngine::Render::StandardCommandBuffer::pre_shadow_mesh_commands(StandardShadowmapping* shadowmapping)
{
...
SlackEngine::Render::StandardCommandBuffer::StandardCommandBuffer(VulkanCommandPool* command_pool,
...
void SlackEngine::Render::StandardCommandBuffer::init_shadow_map(StandardShadowmapping* shadowmapping)
{
...
void SlackEngine::Render::StandardCommandBuffer::load_mesh_shadow_map(StandardShadowmapping* shadowmapping,
...
void SlackEngine::Render::StandardCommandBuffer::init_command_buffer(
...
void SlackEngine::Render::StandardCommandBuffer::init_current_camera(Camera* current_camera)
{
	current_camera_ = current_camera;
}

void SlackEngine::Render::StandardCommandBuffer::load_skybox(VulkanSkyboxInstance* skybox_ref)
{
...
void SlackEngine::Render::StandardCommandBuffer::load_mesh(VulkanMeshInstance* mesh)
{
	//Do not include mesh to delete
	if (mesh->get_pending_deletion())
	{
