...
SlackEngine::Render::StandardTexture::StandardTexture(const std::string& file_path)
{
...
void SlackEngine::Render::StandardTexture::transition_image_layout(vk::Image* image, const vk::Format& format,
...
int SlackEngine::Render::StandardTexture::get_texture_width() const
{
	return tex_width_;
}

int SlackEngine::Render::StandardTexture::get_texture_height() const
{
	return tex_height_;
}

int SlackEngine::Render::StandardTexture::get_texture_channels() const
{
