...
SlackEngine::Render::SkyboxTexture::SkyboxTexture(const std::array<std::string, 6>& files_path)
{
	//-----------------------
	// load images
	//-----------------------
...
SlackEngine::Render::SkyboxTexture::~SkyboxTexture()
{
	//Double-check that the images has been erased
	delete_temporary_images();
}

void SlackEngine::Render::SkyboxTexture::delete_temporary_images()
{
...
int SlackEngine::Render::SkyboxTexture::get_texture_width() const
{
	return get_texture_height();
}

int SlackEngine::Render::SkyboxTexture::get_texture_height() const
{
