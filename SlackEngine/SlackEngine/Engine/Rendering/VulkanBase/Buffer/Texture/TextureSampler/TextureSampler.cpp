...
SlackEngine::Render::TextureSampler::TextureSampler(const uint32_t& mip_levels)
...
SlackEngine::Render::TextureSampler::TextureSampler(const uint32_t& mip_levels, const vk::Filter mag_filter,
...
SlackEngine::Render::TextureSampler::~TextureSampler()
{
	VulkanDevice::get_instance()->get_logical_device()->destroySampler(texture_sampler_);
}

vk::Sampler* SlackEngine::Render::TextureSampler::get_texture_sampler()
{
