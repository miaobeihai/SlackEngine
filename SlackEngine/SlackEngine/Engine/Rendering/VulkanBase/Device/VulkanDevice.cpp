...
SlackEngine::Render::VulkanDevice* SlackEngine::Render::VulkanDevice::instance_ = nullptr;

void SlackEngine::Render::VulkanDevice::init(vk::SurfaceKHR* vulkan_surface_input_ref)
{
...
SlackEngine::Render::VulkanDevice::~VulkanDevice()
{
	delete VulkanMemoryAllocator::get_instance();
	device_.destroy();
}

SlackEngine::Render::VulkanDevice* SlackEngine::Render::VulkanDevice::get_instance()
{
...
void SlackEngine::Render::VulkanDevice::choose_physical_device()
{
...
void SlackEngine::Render::VulkanDevice::create_logical_device()
{
...
vk::PhysicalDevice* SlackEngine::Render::VulkanDevice::get_physical_device()
{
	return &physical_device_;
}

vk::Device* SlackEngine::Render::VulkanDevice::get_logical_device()
{
	return &device_;
}

SlackEngine::Render::VulkanDevice::operator VkDevice_T*()
{
	return *(reinterpret_cast<VkDevice*>(&device_));
}

SlackEngine::Render::VulkanDevice::operator vk::Device() const
{
	return device_;
}

SlackEngine::Render::BaseQueue::QueueFamilyIndices SlackEngine::Render::VulkanDevice::
get_cached_queue_family_indices() const
{
	return cached_indices_;
}

bool SlackEngine::Render::VulkanDevice::is_device_suitable(vk::PhysicalDevice* physical_device_input,
                                                           vk::SurfaceKHR* surface)
{
	...
	std::string gpu_name(static_cast<const char*>(device_properties.deviceName));
...
bool SlackEngine::Render::VulkanDevice::check_device_extension_support(vk::PhysicalDevice* device) const
{
...
void SlackEngine::Render::VulkanDevice::init_vulkan_allocator() const
{
	VulkanMemoryAllocator* allocator = VulkanMemoryAllocator::get_instance();
	allocator->init(physical_device_, device_,*VukanInstance::get_instance()->get_vulkan_instance());
	Debug::DebugLog::print_to_console_log("VulkanMemoryAllocator loaded!");
}

SlackEngine::Render::VulkanSwapChain::SwapChainSupportDetails SlackEngine::Render::VulkanDevice::
...
vk::SampleCountFlagBits SlackEngine::Render::VulkanDevice::get_max_usable_sample_count() const
{
...
vk::SampleCountFlagBits SlackEngine::Render::VulkanDevice::get_msaa_samples() const
{
	return msaa_samples_;
}

SlackEngine::Render::BaseQueue::QueueFamilyIndices SlackEngine::Render::VulkanDevice::find_queue_families(
