...
#include "ShadowmappingDescriptorSet.h"

#include "DebugLog.h"
#include "Device/VulkanDevice.h"

SlackEngine::Render::ShadowmappingDescriptorSet::ShadowmappingDescriptorSet()
{
...
void SlackEngine::Render::ShadowmappingDescriptorSet::create_descriptor_sets(vk::DescriptorPool* descriptor_pool,
