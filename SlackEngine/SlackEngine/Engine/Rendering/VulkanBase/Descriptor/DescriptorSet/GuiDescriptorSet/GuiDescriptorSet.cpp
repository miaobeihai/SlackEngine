...
#include "GuiDescriptorSet.h"

#include "DebugLog.h"
#include "Device/VulkanDevice.h"

SlackEngine::Render::GuiDescriptorSet::GuiDescriptorSet() : BaseDescriptorSet()
{
...
void SlackEngine::Render::GuiDescriptorSet::create_descriptor_sets(vk::DescriptorPool* descriptor_pool,
