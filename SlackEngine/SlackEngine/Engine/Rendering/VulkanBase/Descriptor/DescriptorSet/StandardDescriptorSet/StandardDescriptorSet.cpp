...
SlackEngine::Render::StandardDescriptorSet::StandardDescriptorSet()
{
...
void SlackEngine::Render::StandardDescriptorSet::create_descriptor_sets(vk::DescriptorPool* descriptor_pool,
