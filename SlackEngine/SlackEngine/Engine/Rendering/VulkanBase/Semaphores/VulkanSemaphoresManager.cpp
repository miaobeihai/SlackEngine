...
SlackEngine::Render::VulkanSemaphoresManager::VulkanSemaphoresManager(
...
const std::vector<vk::Semaphore>* SlackEngine::Render::VulkanSemaphoresManager::
...
const std::vector<vk::Fence>* SlackEngine::Render::VulkanSemaphoresManager::get_in_flight_fences_vector() const
{
