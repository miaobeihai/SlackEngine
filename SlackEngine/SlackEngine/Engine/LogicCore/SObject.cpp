...
glm::mat4 SlackEngine::Core::SObject::generate_transform_matrix(const STransform& transform) const
{
...
glm::mat4 SlackEngine::Core::SObject::generate_unscaled_transform_matrix(const STransform& transform) const
{
...
SlackEngine::Core::SObject::SObject(const std::string& input_object_name) : object_name_(input_object_name)
{
}

SlackEngine::Core::SObject::~SObject()
{
	//Empty here
}

std::string SlackEngine::Core::SObject::to_string() const
{
	return object_name_;
}
