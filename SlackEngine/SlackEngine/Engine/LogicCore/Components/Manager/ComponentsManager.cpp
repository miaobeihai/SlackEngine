...
void SlackEngine::Core::ComponentsManager::set_render_manager(Render::RenderManager* input_render_manager_ref)
{
	render_manager_ref_ = input_render_manager_ref;
}

void SlackEngine::Core::ComponentsManager::set_physics_manager(Physics::PhysicsManager* input_physics_manager)
{
	physics_manager_ref_ = input_physics_manager;
}

void SlackEngine::Core::ComponentsManager::set_audio_manager(Audio::AudioManager* input_audio_manager)
{
	audio_manager_ref_ = input_audio_manager;
}

SlackEngine::Core::MeshComponent* SlackEngine::Core::ComponentsManager::create_new_mesh_component(
...
void SlackEngine::Core::ComponentsManager::destroy_mesh_component(
...
SlackEngine::Core::CameraComponent* SlackEngine::Core::ComponentsManager::get_camera()
{
	if (!camera_)
	{
...
void SlackEngine::Core::ComponentsManager::update_rigidbody_physics(const float factor)
{
...
SlackEngine::Core::BoxRigidBodyComponent* SlackEngine::Core::ComponentsManager::create_box_rigidbody_component(
...
SlackEngine::Core::CapsuleRigidBodyComponent* SlackEngine::Core::ComponentsManager::create_capsule_rigidbody_component(
...
SlackEngine::Core::SphereRigidBodyComponent* SlackEngine::Core::ComponentsManager::create_sphere_rigidbody_component(
...
SlackEngine::Core::raycast_result SlackEngine::Core::ComponentsManager::execute_single_raycast(
...
std::vector<SlackEngine::Core::raycast_result> SlackEngine::Core::ComponentsManager::execute_multi_raycast(
	const SVector3& start, const SVector3& end)
{
	const std::vector<Physics::RaycastResultInfo> result = physics_manager_ref_->execute_multi_raycast(start, end);
	std::vector<SlackEngine::Core::raycast_result> return_info;
...
SlackEngine::Core::AudioComponent2D* SlackEngine::Core::ComponentsManager::create_2d_sound(
	const std::string& filename) const
{
	return new AudioComponent2D(audio_manager_ref_->load_2d_sound(filename));
}

SlackEngine::Core::AudioComponent3D* SlackEngine::Core::ComponentsManager::create_3d_sound(
	const std::string& filename) const
{
	return new AudioComponent3D(audio_manager_ref_->load_3d_sound(filename));
}

void SlackEngine::Core::ComponentsManager::unload_sound(AudioComponent* audio) const
{
	audio_manager_ref_->unload_sound(audio->get_raw_source());
}

void SlackEngine::Core::ComponentsManager::destroy_rigidbody_component(RigidBodyComponent* component_to_destroy)
{
	//If the element is present
...
void SlackEngine::Core::ComponentsManager::set_gravity(const SVector3& gravity) const
{
	physics_manager_ref_->set_gravity(gravity);
}

SlackEngine::Core::SVector3 SlackEngine::Core::ComponentsManager::get_gravity() const
{
	return physics_manager_ref_->get_gravity();
}

SlackEngine::Core::BoxTriggerComponent* SlackEngine::Core::ComponentsManager::create_box_trigger_component(
...
void SlackEngine::Core::ComponentsManager::destroy_trigger_component(TriggerComponent* component_to_destroy)
{
	//If the element is present
