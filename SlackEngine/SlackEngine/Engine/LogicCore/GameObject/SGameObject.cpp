...
SlackEngine::Core::SGameObject::SGameObject(const std::string& object_name,
                                            const STransform& input_object_transform)
	: SObject(object_name), object_transform_(input_object_transform)
{
}

SlackEngine::Core::SGameObject::~SGameObject()
{
...
void SlackEngine::Core::SGameObject::game_start()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::game_update(float time)
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::on_gui()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::spawn()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::respawn()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::die()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::kill()
{
	//This will be defined by the user when is necessary, otherwise it will have no effect
}

void SlackEngine::Core::SGameObject::set_should_update(const bool should_update)
{
	this->should_update_ = should_update;
}

bool SlackEngine::Core::SGameObject::get_should_update() const
{
	return should_update_;
}

void SlackEngine::Core::SGameObject::set_object_location(const SVector3& location, const bool should_update_relative)
{
...
void SlackEngine::Core::SGameObject::set_object_rotation(const SVector3& rotation, const bool should_update_relative)
{
...
void SlackEngine::Core::SGameObject::set_object_scale(const SVector3& scale, const bool should_update_relative)
{
...
void SlackEngine::Core::SGameObject::add_object_rotation(const SVector3& rotation)
{
...
SlackEngine::Core::SVector3 SlackEngine::Core::SGameObject::get_object_location() const
{
	return object_transform_.get_position();
}

SlackEngine::Core::SVector3 SlackEngine::Core::SGameObject::get_object_rotation() const
{
	return object_transform_.get_rotation();
}

SlackEngine::Core::SVector3 SlackEngine::Core::SGameObject::get_object_scale() const
{
	return object_transform_.get_scale();
}

void SlackEngine::Core::SGameObject::update_relative_location()
{
	if (father_object_)
	{
...
void SlackEngine::Core::SGameObject::update_relative_rotation()
{
	if (father_object_)
	{
...
void SlackEngine::Core::SGameObject::update_relative_scale()
{
	if (father_object_)
	{
...
void SlackEngine::Core::SGameObject::update_object_location()
{
...
void SlackEngine::Core::SGameObject::update_object_rotation()
{
...
void SlackEngine::Core::SGameObject::update_object_scale()
{
	object_transform_.set_scale(father_object_->object_transform_.get_scale() + object_relative_transform_.get_scale());
}

void SlackEngine::Core::SGameObject::add_component(SComponent* component, const bool update_position)
{
...
void SlackEngine::Core::SGameObject::remove_component(SComponent* component)
{
...
const std::vector<SlackEngine::Core::SComponent*>* SlackEngine::Core::SGameObject::get_components() const
{
	return &object_components_;
}

void SlackEngine::Core::SGameObject::add_child(SGameObject* game_object)
{
...
void SlackEngine::Core::SGameObject::remove_child(SGameObject* game_object)
{
...
const std::vector<SlackEngine::Core::SGameObject*>* SlackEngine::Core::SGameObject::get_child() const
{
	return &object_child_;
}

SlackEngine::Core::SGameObject* SlackEngine::Core::SGameObject::get_father() const
{
