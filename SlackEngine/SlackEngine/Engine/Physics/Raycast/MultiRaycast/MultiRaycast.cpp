...
SlackEngine::Physics::MultiRaycast::MultiRaycast(rp3d::DynamicsWorld* world_ref)
	: world_ref_(world_ref)
{
}

std::vector<SlackEngine::Physics::RaycastResultInfo> SlackEngine::Physics::MultiRaycast::execute_ray(
...
SlackEngine::Physics::RigidBody* SlackEngine::Physics::MultiRaycast::search_rigidbody(
...
reactphysics3d::decimal SlackEngine::Physics::MultiRaycast::notifyRaycastHit(const reactphysics3d::RaycastInfo& info)
{
