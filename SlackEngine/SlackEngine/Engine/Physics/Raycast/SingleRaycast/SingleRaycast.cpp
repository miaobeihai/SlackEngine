...
SlackEngine::Physics::SingleRaycast::SingleRaycast(rp3d::DynamicsWorld* world_ref)
	: world_ref_(world_ref)
{
}

SlackEngine::Physics::RigidBody* SlackEngine::Physics::SingleRaycast::search_rigidbody(
...
SlackEngine::Physics::RaycastResultInfo SlackEngine::Physics::SingleRaycast::execute_ray(const Core::SVector3& start,
...
reactphysics3d::decimal SlackEngine::Physics::SingleRaycast::notifyRaycastHit(const reactphysics3d::RaycastInfo& info)
{
